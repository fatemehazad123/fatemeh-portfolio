...
export default function ShaderBackground() {
  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      const vec4 lineColor  = vec4(0.40, 0.80, 0.76, 1.0);
      const vec4 lineColor2 = vec4(0.90, 0.52, 0.34, 1.0);
      const vec4 lineColor3 = vec4(0.78, 0.88, 0.80, 1.0);
      ...
      void main() {
        ...
        for(int l = 0; l < linesPerGroup; l++) {
          ...
          vec4 chosenColor;
          if(mod(float(l), 3.0) < 1.0)      chosenColor = lineColor;
