      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2rem' }}>
            <p style={{ fontFamily: 'var(--font-inter)', fontSize: 16, fontWeight: 300, color: 'rgba(255,255,255,0.82)', lineHeight: 1.8 }}>
          ...
          <div style={{ borderLeft: '2px solid var(--teal)', paddingLeft: '1.25rem', marginBottom: '1rem' }}>
            <p style={{ fontFamily: 'var(--font-playfair)', fontSize: 15, fontStyle: 'italic', color: 'white', opacity: 0.82, lineHeight: 1.7, margin: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2rem' }}>
            <blockquote style={{ borderLeft: '2px solid var(--teal)', paddingLeft: '1.25rem', margin: 0 }}>
              <p style={{ fontFamily: 'var(--font-playfair)', fontSize: 15, fontStyle: 'italic', color: 'white', opacity: 0.82, lineHeight: 1.7, marginBottom: '0.6rem' }}>
              ...
              <cite style={{ fontFamily: 'var(--font-inter)', fontSize: 12, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.14em', color: 'var(--teal)', fontStyle: 'normal', display: 'block' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
            {CORE_SKILLS.map(skill => (
              <span key={skill} style={{ fontFamily: 'var(--font-inter)', fontSize: 13, fontWeight: 500, letterSpacing: '0.06em', padding: '0.35rem 0.85rem', borderRadius: 20, border: '1px solid rgba(79,166,161,0.5)', color: 'var(--teal)', background: 'rgba(79,166,161,0.08)' }}>
                {skill}
              </span>
            ))}
            {OTHER_SKILLS.map(skill => (
              <span key={skill} style={{ fontFamily: 'var(--font-inter)', fontSize: 13, fontWeight: 400, letterSpacing: '0.06em', padding: '0.35rem 0.85rem', borderRadius: 20, border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.65)', background: 'transparent' }}>
                {skill}
              </span>
            ))}
          </div>
